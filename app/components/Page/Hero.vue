...
<template>
  <UContainer class="flex flex-col lg:flex-row gap-4">
    <div class="flex-1 flex flex-col gap-4">
      <div class="flex-1">
        <UCard variant="soft" class=" flex justify-evenly    flex-col h-full bg-red-500 dark:bg-night-700 text-white   rounded-4xl  ">
          <div>
            <p class="pb-6 ">
      ...
      <div class="flex-1">
        <UCard variant="soft" class=" bg-night-200 dark:bg-night-900 h-full text-night-900 dark:text-white   rounded-4xl  ">
          <p class="py-6">
